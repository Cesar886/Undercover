  ...
  return (
    <div ref={ref} className="relative inline-block">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-1 w-36 bg-white border border-stone-200 rounded-lg shadow-lg z-20 overflow-hidden animate-fade-in"
        >
          <button
            role="menuitem"
            onClick={() => { setOpen(false); onEdit(); }}
            className="w-full flex items-center gap-2 px-3 py-2 text-[13px] text-stone-700 hover:bg-stone-50 text-left transition-colors"
          >
