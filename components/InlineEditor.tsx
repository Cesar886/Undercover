      ...
      <div className="flex items-center justify-between mt-2">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            onClick={onCancel}
            disabled={saving}
            className="px-3 py-1.5 text-xs text-stone-400 dark:text-zinc-500 hover:text-stone-700 dark:hover:text-zinc-200 hover:bg-stone-100 dark:hover:bg-zinc-800 rounded-lg transition-all"
          >
            Cancelar
          </button>
          <button
