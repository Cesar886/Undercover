...
export const BOARDS: Board[] = [
  ...
  { slug: 'confesiones', name: 'Confesiones', description: 'Lo que no le dirías a nadie en persona', isSystem: true, bg: 'rgba(147,51,234,0.07)', border: '#9333ea', text: '#7e22ce', glow: '0 0 0 1px #9333ea30, 0 2px 10px rgba(147,51,234,0.28)' },
  { slug: 'stickers', name: 'Stickers', description: 'Tus mejores stickers aquí', isSystem: true, bg: 'rgba(234,179,8,0.07)', border: '#eab308', text: '#ca8a04', glow: '0 0 0 1px #eab30830, 0 2px 10px rgba(234,179,8,0.28)' },
];
